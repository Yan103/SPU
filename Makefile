...
SRC_DIR   = src
INC_DIR   = include
INC_DIR2  = /home/projects/SPU/stack/include
OBJ_DIR   = /home/projects/SPU/obj
BIN_DIR   = /home/projects/SPU/build
SOURCES   = $(wildcard $(SRC_DIR)/*.cpp)
INCLUDES  = $(wildcard $(INC_DIR)/*.h)
OBJECTS   = $(SOURCES:$(SRC_DIR)/%.cpp=$(OBJ_DIR)/%.o)
EXECUTABLE= $(BIN_DIR)/cpu

run:
	/home/projects/SPU/build/assembler
	/home/projects/SPU/build/cpu
	/home/projects/SPU/build/disassembler